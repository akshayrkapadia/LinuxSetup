...
sudo apt install tmux zsh vim python3-pip curl # Install software 
sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" # Install Oh-My-Zsh package manager
